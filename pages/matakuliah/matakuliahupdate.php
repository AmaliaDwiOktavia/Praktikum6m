...
<div class="row">
    <form action="" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_matakuliah" name="nama_matakuliah" value="<?php echo $data['nama_matakuliah'] ?>" placeholder="Isi Nama Mata Kuliah" required>
        </div>
        <div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="jam" name="jam" placeholder="Isi Jam" value="<?php echo $data['jam'] ?>" required>
        </div>
        </div>
            <div class="mb-3">
